...
public class Butterfly : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(!followingEgg)
        {
            followPoint.transform.position = new Vector3(target.transform.position.x + x, target.transform.position.y + 7, target.transform.position.z + y);
        }
        else if(followingEgg)
        {
            followPoint.transform.position = new Vector3(egg.transform.position.x + x, egg.transform.position.y + 7, egg.transform.position.z + y);
        }
    }
